...
export const BottomBar = () => {
    ...
    return (
        <div className="flex flex-col-reverse md:flex-row items-center  mt-4 md:mt-0 justify-between gap-4 text-sm">
            <div className="flex justify-center gap-1">
                ©
                <p
                    className="w-full text-gray-900 overflow-hidden flex"
