...
export const ProductCard = ({ product }: Props) => {
    ...
    return (
        <>
            <div className="group relative mt-2 md:mt-0 overflow-hidden rounded-lg border bg-card transition-all hover:scale-150 cursor-pointer duration-300 select-none">
